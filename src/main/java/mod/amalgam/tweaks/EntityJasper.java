...
import mod.amalgam.tweaks.fusion.EntityMalachite;
import mod.heimrarnadalr.kagic.util.Colors;
import mod.starlight.init.Starlight;
...
public class EntityJasper extends EntityQuartz implements IAnimals {
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
		...
		special = Starlight.isChristmas() ? 8 : this.rand.nextFloat() < 0.9 ? biomeSpecial : special;
	...
	public boolean alternateInteract(EntityPlayer player) {
		...
		Starlight.instance.chatInfoMessage("Special is " + this.getSpecial());
		Starlight.instance.chatInfoMessage("mark1Color is " + this.getMark1Color());
		Starlight.instance.chatInfoMessage("mark1 is " + this.getMark1());
		Starlight.instance.chatInfoMessage("mark2Color is " + this.getMark2Color());
		Starlight.instance.chatInfoMessage("mark2 is " + this.getMark2());
		return false;
	}
