	...
	public boolean attackEntityAsMob(Entity entity) {
		if (!this.world.isRemote) {
			...
			if (this.isCharged()) {
        		...
        		((EntityLivingBase) entity).addPotionEffect(new PotionEffect(MobEffects.MINING_FATIGUE, 80));
        		((EntityLivingBase) entity).addPotionEffect(new PotionEffect(MobEffects.SLOWNESS, 80));
