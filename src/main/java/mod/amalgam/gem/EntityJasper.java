			...
			if (this.isCharged()) {
				...
				for (EntityLivingBase living : list) {
					if (!this.isOwner(living)) {
						...
						if (shouldAttack) {
							if (living.attackEntityFrom(DamageSource.causeMobDamage(this), (float)(7 + this.rand.nextInt(15)))) {
								living.motionY += 0.9D;
				...
				if (entity.attackEntityFrom(DamageSource.causeMobDamage(this), (float)(10 + this.rand.nextInt(15)))) {
					entity.motionY += 0.4D;
