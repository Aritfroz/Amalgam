...
public class EntityWatermelonTourmaline extends EntityAmalgam implements IAnimals {
	...
	public EntityWatermelonTourmaline(World world) {
        ...
        this.tasks.addTask(1, new EntityWatermelonTourmaline.AITourmalineBlowAttack(this, 2, 8, 12));
	...
	public static class AITourmalineBlowAttack extends EntityAIBase {
		...
		public AITourmalineBlowAttack(EntityWatermelonTourmaline tourmaline, double blowStrength, double distance, double areaAffected) {
