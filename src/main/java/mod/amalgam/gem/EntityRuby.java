...
public class EntityRuby extends EntityAmalgam implements IAnimals {
    ...
    public boolean canPickupItem(Item item) {
        return this.isDefective() && (item instanceof ItemSword || item instanceof ItemTool || item instanceof ItemBow);
    }
