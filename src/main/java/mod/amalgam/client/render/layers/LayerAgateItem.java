...
public class LayerAgateItem implements LayerRenderer<EntityAgate> {
    ...
    @Override
	public void doRenderLayer(EntityAgate entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
