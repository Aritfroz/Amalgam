...
import mod.amalgam.client.render.RenderAquamarine;
...
public class LayerAquamarineItem implements LayerRenderer<EntityAquamarine> {
	...
	@Override
	public void doRenderLayer(EntityAquamarine entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
