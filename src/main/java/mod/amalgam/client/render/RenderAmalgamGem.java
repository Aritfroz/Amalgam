...
public class RenderAmalgamGem<T extends EntityGem> extends RenderBiped<T> {
	public RenderAmalgamGem(RenderManager manager, ModelBiped model, float shadowSize) {
